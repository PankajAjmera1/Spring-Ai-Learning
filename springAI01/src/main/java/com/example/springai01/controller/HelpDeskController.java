...
import com.example.springai01.tools.HelpDeskTool;
...
public class HelpDeskController {
    ...
    public HelpDeskController(@Qualifier("helpdeskChatClient") ChatClient chatClient, HelpDeskTool helpDeskTool) {
